function addRealm() {
    ...
    html:
      '<input type="input" id="realmname" class="swal2-input" placeholder="Realm Name">' +
      '<input type="input" id="realmportal" class="swal2-input" placeholder="Realm Portal / List">' +
      '<input type="input" id="realmdbhost" class="swal2-input" placeholder="DB Hostname">' +
      '<input type="input" id="realmdbuser" class="swal2-input" placeholder="DB Username">' +
      '<input type="password" id="realmdbpass" class="swal2-input" placeholder="DB Password">' +
      '<input type="input" id="realmdbname" class="swal2-input" placeholder="DB Name">' +
    ...
    preConfirm: () => {
      return [
          ...
          rdbname   = document.getElementById('realmdbname').value,
